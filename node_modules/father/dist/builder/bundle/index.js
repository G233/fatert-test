...
exports.default = async (opts) => {
    ...
    for (const config of opts.configProvider.configs) {
        utils_1.logger.info(`Bundle from ${utils_1.chalk.yellow(config.entry)} to ${utils_1.chalk.yellow(path_1.default.join(config.output.path, config.output.filename))}`);
        ...
        await bundler.build({
            ...
            babelPreset: [
                ...
                {
                    presetEnv: {},
                    presetReact: (0, utils_2.getBabelPresetReactOpts)(opts.configProvider.pkg),
                    presetTypeScript: {},
