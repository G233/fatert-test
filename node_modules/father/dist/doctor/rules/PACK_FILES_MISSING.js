...
exports.default = (api) => {
    api.addRegularCheckup(({ bundleConfigs, bundlessConfigs, preBundleConfig }) => {
        if (api.pkg.files) {
            ...
            Object.values(preBundleConfig.deps).forEach((c) => entities.push(path_1.default.basename(c.output)));
            Object.values(preBundleConfig.dts).forEach((c) => entities.push(path_1.default.basename(c.output)));
